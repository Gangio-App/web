        ...
        <Buttons>
          <SeparatedColumn>
            ...
            <CategoryButton
              ...
              onClick={() =>
                window.open(
                  "https://buymeacoffee.com/korybantes",
                )
              }
              description={
          ...
          <SeparatedColumn>
            <Show when={!window.native}>
              <CategoryButton
                ...
                description={
                  <Trans>
                    Get the native desktop app for Windows and macOS.
                  </Trans>
                }
                icon={<MdDownload />}
              >
                <Trans>Download Gangio Desktop</Trans>
              </CategoryButton>
            </Show>
            ...
            >
              <Trans>Give feedback on Gangio</Trans>
            </CategoryButton>
            <CategoryButton
