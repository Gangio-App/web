...
export function useError() {
  ...
  return (error: unknown) => {
    ...
    if (
      ...
      switch (err.type) {
        ...
        case "FailedValidation":
          return t`Your input is invalid, please check the information you entered and try again.`;
        ...
        default:
          return t`Uncaught Gangio error: ${err.type}`;
      }
    }
    ...
    // If we still don't know the error, show a generic message
