...
import MdMusicNote from "@material-design-icons/svg/outlined/music_note.svg?component-solid";
...
function SpotifyAccount() {
  ...
  const linkSpotify = () => {
    ...
    const authUrl = `https://accounts.spotify.com/authorize?client_id=${clientId}&response_type=code&redirect_uri=${redirectUri}&scope=${scope}&state=${userId}`;
  ...
  return (
    <CategoryButton.Group>
      <CategoryButton
        action="chevron"
        onClick={linkSpotify}
        icon={<MdMusicNote {...iconSize(22)} />}
        description="Connect your Spotify account to show what you're listening to on your profile"
      >
        Spotify Integration
      </CategoryButton>
    </CategoryButton.Group>
