  ...
  return (
    <Column gap="lg">
      <CategoryButtonGroup>
        ...
        <Link
          href="https://github.com/orgs/Gangio-App/discussions/categories/feature-suggestions"
          target="_blank"
        >
          <CategoryButton
            action="external"
            ...
            onClick={() => void 0}
            description={
              <Trans>Suggest new Gangio features on GitHub discussions.</Trans>
            }
          >
        ...
        <Link
          href="https://github.com/orgs/Gangio-App/discussions/categories/feedbacks"
          target="_blank"
        >
          <CategoryButton
            action="external"
        ...
        <Link
          href="https://github.com/Gangio-App/app/issues"
          target="_blank"
        >
          <CategoryButton
            action="external"
        ...
        <Switch fallback={null}>
          <Match when={showLoungeButton && isInLounge}>
            <CategoryButton
              ...
              icon={<MdGroups3 />}
            >
              <Trans>Go to the Gangio Lounge</Trans>
            </CategoryButton>
          </Match>
          <Match when={showLoungeButton && !isInLounge}>
            <CategoryButton
              ...
              icon={<MdGroups3 />}
            >
              <Trans>Join the Gangio Lounge</Trans>
            </CategoryButton>
          </Match>
        </Switch>
      </CategoryButtonGroup>
