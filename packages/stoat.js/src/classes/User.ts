...
export class User {
  ...
  get profile(): UserProfile | undefined {
    return this.#collection.getUnderlyingObject(this.id).profile;
  }
  ...
  get canBeMessagedByNonFriends(): boolean {
    return (
      !this.profile || this.profile.directMessageVisibility !== "Friends"
    );
  }
  ...
  get permission(): number {
    ...
    if (
      ...
      if (
        this.#collection.client.user?.bot ||
        this.bot ||
        this.canBeMessagedByNonFriends
      ) {
